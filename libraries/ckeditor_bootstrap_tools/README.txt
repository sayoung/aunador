CKEditor Bootstrap Tools module adds features to operate Bootstrap blocks inside CKEditor in Drupal 8.
...
6. Go to node create/edit page, choose the text format with CKEditor Bootstrap Tools plugins.
