/**
 * @file
 * CKEditor 'ckeditor_bootstrap_tools' plugin admin behavior.
 */
...
(function ($, Drupal, drupalSettings) {
  ...
  /**
   * Provides the summary for the "ckeditor_bootstrap_tools" plugin settings vertical tab.
   *
   * @type {Drupal~behavior}
   *
   * @prop {Drupal~behaviorAttach} attach
   *   Attaches summary behaviour to the "ckeditor_bootstrap_tools" settings vertical tab.
   */

  Drupal.behaviors.ckeditor_bootstrap_toolsSettingsSummary = {
    attach: function () {
      $('[data-ckeditor-plugin-id="jsplusBootstrapTools"]').drupalSetSummary(function (context) {
        return 'JS+ Bootstrap Tools configuration';
      });
      $('head').append('<style>' +
          ...
          '</style>')
      $('details[data-ckeditor-plugin-id=jsplusBootstrapTools] [data-url-help]').each(
          function() {
      ...
      $('details[data-ckeditor-plugin-id=jsplusBootstrapTools] [data-param-priority]').each(
          function() {
