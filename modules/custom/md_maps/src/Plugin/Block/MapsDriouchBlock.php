...
/**
 * Provides a 'MapsDriouchBlock' block.
 *
 * @Block(
 *  id = "md_maps_prov_driouch_block",
 *  admin_label = @Translation("maps province Driouch Block"),
 * )
 */
class MapsDriouchBlock extends BlockBase {
...
$config = \Drupal::config("md_maps_prov_d.setting");
    //print_r($sliders);exit;
  
    return array(
      '#theme' => 'theme_md_maps_pro_driouch',
	   
	  '#md_maps_prov_d' => (object)array(
