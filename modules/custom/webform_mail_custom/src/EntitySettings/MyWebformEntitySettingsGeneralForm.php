...
namespace Drupal\webform_mail_custom\EntitySettings;
 ...
 */
class MyWebformEntitySettingsGeneralForm extends WebformEntitySettingsBaseForm {
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    $form['page_settings']['page'] = [
      '#type' => 'checkbox',
      '#title' => $this->t('Allow users to post submissions from a dedicated URL 1'),
