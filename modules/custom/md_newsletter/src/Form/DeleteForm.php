...
class DeleteForm extends ConfirmFormBase {
  ...
  public function getCancelUrl() {
    return new Url('md_newsletter.display_table_controller_display');
}
public function getDescription() {
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
   ...
   $query = \Drupal::database();
    //echo $this->id; die;
    $query->delete('md_newsletter_emails')
        //->fields($field)
        ...
        // }
    $form_state->setRedirect('md_newsletter.display_table_controller_display');
  }


  //   $num_deleted = db_delete('md_newsletter')
  // ->condition('id', 1)
  // ->execute();
