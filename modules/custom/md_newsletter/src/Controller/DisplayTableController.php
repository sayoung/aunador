...
class DisplayTableController extends ControllerBase {
  ...
  public function getContent() {
    ...
    $build = [
      'description' => [
        '#theme' => 'md_newsletter_description',
        '#description' => 'foo',
        '#attributes' => [],
      ],
    ];
...
//select records from table
    ...
    foreach($results as $data){
        $delete = Url::fromUserInput('/backoffice/md_newsletter/form/delete/'.$data->id);
        //$edit   = Url::fromUserInput('/backoffice/md_newsletter/form/md_newsletter?num='.$data->id);
