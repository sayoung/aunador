...
class DeleteForm extends ConfirmFormBase {
  ...
  public function getCancelUrl() {
    return new Url('aust_newsletter.display_table_controller_display');
}
public function getDescription() {
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
   ...
   $query = \Drupal::database();
    //echo $this->id; die;
    $query->delete('aust_newsletter_emails')
        //->fields($field)
        ...
        // }
    $form_state->setRedirect('aust_newsletter.display_table_controller_display');
  }


  //   $num_deleted = db_delete('aust_newsletter')
  // ->condition('id', 1)
  // ->execute();
