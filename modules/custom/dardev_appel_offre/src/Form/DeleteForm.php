...
class DeleteForm extends ConfirmFormBase {
  ...
  public function getCancelUrl() {
    return new Url('dardev_appel_offre.display_table_controller_display');
}
public function getDescription() {
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
   ...
   $query = \Drupal::database();
    //echo $this->id; die;
    $query->delete('dardev_appel_offre_emails')
        //->fields($field)
        ...
        // }
    $form_state->setRedirect('dardev_appel_offre.display_table_controller_display');
  }


  //   $num_deleted = db_delete('dardev_appel_offre')
  // ->condition('id', 1)
  // ->execute();
