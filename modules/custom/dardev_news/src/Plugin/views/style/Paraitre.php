 ...
 * @ViewsStyle(
 *   id = "views_paraitre",
 *   title = @Translation("INRA Latest Vient de Paraitre"),
 *   help = @Translation("Displays rows in a views Latest Paraitre"),
 *   theme = "views_vient_paraitre",
 *   theme_file = "/../views_news.theme.inc",
 *   display_types = {"normal"}
 * )
 */
class Paraitre extends StylePluginBase {
  /**
