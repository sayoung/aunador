 ...
 * @ViewsStyle(
 *   id = "views_webinar",
 *   title = @Translation("INRA Latest Webinar"),
 *   help = @Translation("Displays rows in a views Latest Webinar"),
 *   theme = "views_webinar_series",
 *   theme_file = "/../views_news.theme.inc",
 *   display_types = {"normal"}
 * )
 */
class Webinar extends StylePluginBase {
  /**
  ...
  protected function defineOptions() {
    ...
    $options['animateur_field'] = ['default' => NULL];
  ...
  public function buildOptionsForm(&$form, FormStateInterface $form_state) {
    ...
    if (isset($form['grouping'])) {
      ...
      $form['animateur_field'] = [
        '#type' => 'select',
        '#title' => $this->t('animateur field'),
        '#options' => $this->displayHandler->getFieldLabels(TRUE),
        '#required' => TRUE,
        '#default_value' => $this->options['animateur_field'],
        '#description' => $this->t('Select the field that will be used for the animateur.'),
      ];
      $form['url_field'] = [
        '#type' => 'select',
