...
class MandrillMail implements MailInterface {
  ...
  public function mail(array $message) {
    ...
    $overrides = $message['params']['mandrill']['overrides'] ?? [];
    $mandrill_message = $overrides + [
      'id' => $message['id'],
      'module' => $message['module'],
      'html' => $message['body'],
      'text' => $plain_text,
      ...
      'tags' => [$message['id']],
      'google_analytics_domains' => ($this->config->get('mandrill_analytics_domains')) ? explode(',', $this->config->get('mandrill_analytics_domains')) : [],
