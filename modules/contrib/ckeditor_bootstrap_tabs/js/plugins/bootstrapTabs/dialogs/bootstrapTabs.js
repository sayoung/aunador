  ...
  return {
    ...
    onOk: function() {
      ...
      for ( var i = 0; i < allTabLinks.count(); i++ ) {
        ...
        // Remove data-cke-saved-href if it exists
        if (tabLink.hasAttribute('data-cke-saved-href')) {
          tabLink
            .removeAttribute('data-cke-saved-href');
        }
      };


      Drupal.behaviors.ckeditorTabs.attach();
