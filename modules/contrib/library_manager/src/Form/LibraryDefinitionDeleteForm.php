...
class LibraryDefinitionDeleteForm extends EntityDeleteForm {
  ...
  public function getQuestion() {
    return $this->t('Are you sure you want to delete the library definition %id?', ['%id' => $this->entity->id()]);
  }
  ...
  protected function getDeletionMessage() {
    return $this->t('Deleted library definition %id.', ['%id' => $this->entity->id()]);
  }
