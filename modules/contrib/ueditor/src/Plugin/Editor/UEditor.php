...
class UEditor extends EditorBase implements ContainerFactoryPluginInterface {
  ...
  public function submitConfigurationForm(array &$form, FormStateInterface $form_state) {
    $form_state->setValue(['basic'], $form_state->getValue(['basic']));
  }
  ...
  public function getJSSettings(Editor $editor) {
    ...
    if(isset($settings['basic'])){
      $settings['basic']['editorPath'] = '/' . \Drupal::service('extension.list.module')->getPath('ueditor') . '/lib/';
      $settings['basic']['serverUrl'] = '/ueditor/controller/upload';
