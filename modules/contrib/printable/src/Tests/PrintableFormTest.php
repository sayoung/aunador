...
class PrintableFormTest extends BrowserTestBase {
  ...
  public function testPrintFormWorks() {
    ...
    $this->assertSession()->fieldValueEquals('print_html_sendtoprinter', $config->get('printable.send_to_printer'), 'The field was found with the correct value.');
    ...
    $this->drupalGet('admin/config/user-interface/printable/print');
    $this->assertSession()->statusCodeEquals(200);
    $this->assertSession()->fieldValueEquals('print_html_sendtoprinter', 1, 'The field was found with the correct value.');
  }
