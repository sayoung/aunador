...
/* themes/au/templates/block/links--language-block.html.twig */
class __TwigTemplate_8e71d96d8ec2617b00ba87b5a2bb5c81199606ec3e1ea86abcadf49c16278204 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
$context["item"], "text_attributes", [], "any", false, false, true, 50)) {
    ...
    {
        return "themes/au/templates/block/links--language-block.html.twig";
    }
    ...
    {
        return array (  97 => 57,  91 => 55,  88 => 53,  81 => 51,  79 => 50,  77 => 49,  75 => 48,  71 => 47,  67 => 46,  63 => 43,  55 => 40,  45 => 38,  43 => 37,  41 => 36,  39 => 35,);
    }
...
{% if links -%}
 ...
 <div class=\"dropdown-content\">
    {%- for key, item in links -%}
      <a{{ item.attributes.addClass(key|clean_class) }}>
        {%- if item.link -%}
          {{ item.link }}
...
{%- endif %}
", "themes/au/templates/block/links--language-block.html.twig", "/opt/drupal/web/themes/au/templates/block/links--language-block.html.twig");
    }
    
    public function checkSecurity()
    {
        static $tags = array("if" => 35, "for" => 46);
        static $filters = array("escape" => 38, "clean_class" => 47);
